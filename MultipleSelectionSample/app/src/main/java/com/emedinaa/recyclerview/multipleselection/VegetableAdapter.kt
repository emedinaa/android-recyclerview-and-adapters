...
import com.emedinaa.recyclerview.multipleselection.Vegetable
import com.emedinaa.recyclerview.multipleselection.R
import kotlinx.android.synthetic.main.row_item.*

class VegetableAdapter(val vegetables:List<Vegetable>):RecyclerView.Adapter<VegetableAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(private val view: View) :RecyclerView.ViewHolder(view){
        ...
        private fun updateRow(model:Vegetable){
            val resource = if(mutableSelectedList.contains(model))  R.drawable.ic_checked else R.drawable.ic_normal
